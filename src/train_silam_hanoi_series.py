...
DATA_FILE = Path("data/processed/train_silam_hanoi_series.csv")
OUT_DIR = Path("data/output")
OUT_DIR.mkdir(parents=True, exist_ok=True)

MODEL_FILE = OUT_DIR / "xgb_silam_hanoi.pkl"
PRED_FILE = OUT_DIR / "predictions_silam_hanoi.csv"
PRED_FULL_FILE = OUT_DIR / "predictions_silam_hanoi_full.csv"
...
def main():
    ...
    # dự báo toàn bộ để dùng cho map/dashboard
