...
OUT_PATH = "data/output/predictions_6pollutants_7days_gbtree.csv"

MODEL_CONFIGS = {
    "pm25": {
        "model_path": "data/output/xgb_pm25_gbtree_model.pkl",
        "features": [
    ...
    "pm10": {
        "model_path": "data/output/xgb_pm10_gbtree_model.pkl",
        "features": [
    ...
    "o3": {
        "model_path": "data/output/xgb_o3_gbtree_model.pkl",
        "features": [
            "silam_o3", "cmaq_o3",
    ...
    "so2": {
        "model_path": "data/output/xgb_so2_gbtree_model.pkl",
        "features": [
            "silam_so2", "cmaq_so2",
    ...
    "co": {
        "model_path": "data/output/xgb_co_gbtree_model.pkl",
        "features": [
            "silam_co", "cmaq_co",
    ...
    "no2": {
        "model_path": "data/output/xgb_no2_gbtree_model.pkl",
        "features": [
