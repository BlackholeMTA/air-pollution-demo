...
IN_PATH = "data/output/predictions_6pollutants_7days.csv"
OUT_PATH = "data/output/vn_aqi_from_predictions_7days.csv"
...
def compute_hourly_aqi(df):
    ...
    for station_id, g in df.groupby("station_id"):
        ...
        for _, row in g.iterrows():
            ...
            # Theo QĐ 1459: bắt buộc phải có ít nhất 1 trong 2 thông số PM10 hoặc PM2.5
...
def main():
    ...
    print("Cột:", aqi_df.columns.tolist())

    print("\nĐộ phủ VN_AQI:")
    print(aqi_df["vn_aqi_hour"].notna().sum())
