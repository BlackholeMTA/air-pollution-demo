...
DATA_FILE = Path("data/processed/train_cmaq_hanoi.csv")
OUT_DIR = Path("data/output")
OUT_DIR.mkdir(parents=True, exist_ok=True)

MODEL_FILE = OUT_DIR / "xgb_cmaq_hanoi.pkl"
PRED_FILE = OUT_DIR / "predictions_cmaq_hanoi.csv"
PRED_FULL_FILE = OUT_DIR / "predictions_cmaq_hanoi_full.csv"
